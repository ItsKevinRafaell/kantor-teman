...
products_data = [
    ...
    ("Web Pro (Tahunan)", "Bayangkan pelanggan gampang nemuin bisnis Anda di Google Maps dan langsung datang ke lokasi. Website 5 halaman lengkap dengan SEO dasar supaya muncul di pencarian Google, plus analytics untuk tracking pengunjung.", 2250000, ["Hingga 5 Halaman", "Domain & Hosting Tahun Pertama", "Google Maps", "SEO Dasar", "Google Analytics", "Tombol WhatsApp", "Sertifikat SSL", "Tampilan Mobile", "Selesai 7-10 Hari Kerja"], "web_dev", False),
    ("Web Expert (Tahunan)", "Bayangkan bisnis Anda terlihat seperti perusahaan besar dengan website premium 10 halaman. Ada blog untuk konten marketing, email profesional, dan loading super cepat supaya pelanggan tidak kabur.", 3750000, ["Hingga 10 Halaman", "Domain & Hosting Tahun Pertama", "Blog/Artikel", "Email Profesional", "Loading Cepat", "Google Maps", "SEO Lengkap + Analytics", "Tombol WhatsApp", "Sertifikat SSL", "Tampilan Mobile", "Selesai 10-14 Hari Kerja"], "web_dev", False),
