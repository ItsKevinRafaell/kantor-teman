...
products_data = [
    ...
    ("Web Starter (Tahunan)", "Website 1 halaman yang bikin bisnis Anda terlihat profesional di internet. Sudah termasuk domain dan hosting tahun pertama. Cocok untuk bisnis yang baru mulai online dan butuh kehadiran digital yang cepat.", 1000000, ["1 Halaman Fokus Penjualan", "Domain & Hosting Tahun Pertama", "Tombol WhatsApp", "Sertifikat SSL (Aman)", "Tampilan Mobile Friendly", "Selesai 5-7 Hari Kerja"], "web_dev", False),
    ("Web Pro (Tahunan)", "Website 5 halaman lengkap dengan Google Maps agar pelanggan mudah menemukan lokasi Anda. Sudah termasuk SEO dasar supaya muncul di pencarian Google, dan analytics untuk melihat berapa banyak pengunjung website Anda.", 2250000, ["Hingga 5 Halaman", "Domain & Hosting Tahun Pertama", "Google Maps", "SEO Dasar", "Google Analytics", "Tombol WhatsApp", "Sertifikat SSL", "Tampilan Mobile", "Selesai 7-10 Hari Kerja"], "web_dev", False),
    ("Web Expert (Tahunan)", "Website 10 halaman premium dengan blog untuk konten marketing, email profesional, dan loading super cepat. Bikin bisnis Anda terlihat seperti perusahaan besar dan dipercaya pelanggan.", 3750000, ["Hingga 10 Halaman", "Domain & Hosting Tahun Pertama", "Blog/Artikel", "Email Profesional", "Loading Cepat", "Google Maps", "SEO Lengkap + Analytics", "Tombol WhatsApp", "Sertifikat SSL", "Tampilan Mobile", "Selesai 10-14 Hari Kerja"], "web_dev", False),
    # Web Development Bulanan
    ("Web Starter (Bulanan)", "Website 1 halaman profesional dengan pembayaran bulanan yang ramah di kantong. Sudah termasuk domain dan hosting. Cocok untuk yang baru mulai bisnis online dan mau test market dulu tanpa commitment besar.", 120000, ["1 Halaman Fokus Penjualan", "Domain & Hosting Tahun Pertama", "Tombol WhatsApp", "Sertifikat SSL", "Tampilan Mobile", "Bisa Berhenti Kapan Saja", "Selesai 5-7 Hari Kerja"], "web_dev_bulanan", True),
    ("Web Pro (Bulanan)", "Website 5 halaman lengkap dengan pembayaran bulanan. Sudah termasuk Google Maps, SEO dasar, dan analytics. Solusi terbaik untuk yang mau tampil profesional di Google tanpa investasi besar di awal.", 250000, ["Hingga 5 Halaman", "Domain & Hosting Tahun Pertama", "Google Maps", "SEO Dasar", "Google Analytics", "Tombol WhatsApp", "Sertifikat SSL", "Tampilan Mobile", "Bisa Berhenti Kapan Saja", "Selesai 7-10 Hari Kerja"], "web_dev_bulanan", True),
    ("Web Expert (Bulanan)", "Website 10 halaman premium dengan blog dan email profesional, bayar bulanan. Sudah termasuk loading cepat, SEO lengkap, dan analytics. Buat yang serius mau dominasi pasar digital tanpa memberatkan cashflow.", 375000, ["Hingga 10 Halaman", "Domain & Hosting Tahun Pertama", "Blog/Artikel", "Email Profesional", "Loading Cepat", "Google Maps", "SEO Lengkap + Analytics", "Tombol WhatsApp", "Sertifikat SSL", "Tampilan Mobile", "Bisa Berhenti Kapan Saja", "Selesai 10-14 Hari Kerja"], "web_dev_bulanan", True),
    # SEO & Google Maps
    ("SEO Starter", "Bikin bisnis Anda muncul di Google saat orang cari layanan di daerah Anda. Kami urus profil Google Business Profile Anda, bikin 2 artikel per bulan, dan kasih laporan performa bulanan. Investasi kecil untuk pertumbuhan besar.", 1000000, ["Setup & Update Foto Google Business Profile", "2 Artikel Lokal SEO / Bulan", "SEO Dasar", "Laporan Performa Bulanan", "Riset Keyword Lokal", "Tanpa Kontrak Jangka Panjang"], "seo", True),
    ("SEO Pro", "Bikin bisnis Anda naik peringkat di Google dan kalahkan kompetitor lokal. Kami audit website Anda, riset keyword strategis, bikin 6-8 artikel per bulan, dan kasih laporan detail trafik & ranking.", 2500000, ["Full Management Google Business Profile", "6-8 Artikel Strategis / Bulan", "Audit Website & Riset Keyword", "Laporan Detail Trafik & Ranking", "SEO Lengkap", "Monitoring Kompetitor", "Tanpa Kontrak Jangka Panjang"], "seo", True),
    ("SEO Expert", "Bikin Anda jadi nomor 1 di Google untuk industri Anda. Kami urus semuanya dari profil Google, artikel 10-12 per bulan, analisis kompetitor, sampai optimasi konversi. Buat yang serius mau jadi market leader.", 4500000, ["Kelola Profil Google Bisnis Lengkap", "10-12 Artikel Berkualitas / Bulan", "Analisis Kompetitor & Optimasi Penjualan", "Strategi Bulanan Lengkap", "SEO Website Lengkap", "Optimasi Konversi Pelanggan", "Dukungan Prioritas", "Tanpa Kontrak Jangka Panjang"], "seo", True),
    # Social Media
    ("Sosmed Starter", "Bikin media sosial bisnis Anda aktif dan profesional. Kami bikin 9 konten feed per bulan dengan desain branded dan caption yang menarik. Cocok untuk yang baru mulai bangun presence digital.", 500000, ["9 Konten Feed (3x Seminggu)", "Desain Branded", "Caption & Hashtag", "1 Platform (Instagram/Facebook)", "Penjadwalan Otomatis", "Laporan Bulanan"], "socmed", True),
    ("Sosmed Pro", "Bikin followers jadi pelanggan. Kami bikin 15 konten feed per bulan, 2 video reels, content plan strategis, dan copywriting persuasif. Hadir di 2 platform dengan laporan performa mingguan.", 1200000, ["15 Konten Feed (Hampir Setiap Hari)", "2 Video Reels", "Content Plan & Strategi Bulanan", "Copywriting Persuasif", "2 Platform (Instagram + Facebook)", "Riset Hashtag & Penjadwalan", "Laporan Performa Mingguan"], "socmed", True),
    ("Sosmed Expert", "Bikin Anda dominasi media sosial. Kami bikin 24 konten feed per bulan, 4 video reels premium, branding guidelines lengkap, dan daily story. Hadir di 3 platform dengan analisis kompetitor.", 2000000, ["24 Konten Feed (Setiap Hari)", "4 Video Reels Premium", "Branding Guidelines Lengkap", "Daily Story Template", "3 Platform (Instagram, Facebook, TikTok)", "Strategi Konten Advanced", "Analisis Kompetitor", "Dukungan Prioritas"], "socmed", True),
    # Maintenance
    ("Maintenance Starter", "Bikin website Anda tetap aman dan jalan lancar. Backup mingguan, scan malware bulanan, dan update otomatis. Cocok untuk website statis yang butuh perawatan minimal.", 350000, ["Backup Mingguan", "Data Disimpan 1 Bulan", "Update WordPress & Plugin", "Scan Malware Bulanan", "Monitoring Keamanan", "Laporan Bulanan"], "maintenance", True),
    ("Maintenance Pro", "Bikin website selalu fresh, aman, dan optimal. Backup mingguan, scan malware, update konten bisnis, setup email profesional, dan manajemen Google Maps. Ada dukungan prioritas dan laporan mingguan.", 750000, ["Backup Mingguan", "Data Disimpan 1 Bulan", "Setup & Troubleshoot Email", "Update Konten Bisnis", "Scan Malware + Hapus", "Manajemen Google Maps", "Monitoring Performa", "Dukungan Prioritas", "Laporan Mingguan"], "maintenance", True),
    ("Maintenance Expert", "Bikin website selalu optimal dengan dukungan prioritas dan keamanan maksimal. Backup harian, scan malware + recovery, optimasi performa, dan monitoring 24/7. Termasuk custom development sampai 5 jam/bulan.", 1500000, ["Backup Harian", "Data Disimpan 3 Bulan", "Dukungan Prioritas (Response < 4 Jam)", "Custom Development (5 Jam/Bulan)", "Keamanan Maksimal", "Scan Malware + Hapus + Recovery", "Optimasi Performa", "Monitoring 24/7", "Laporan Mingguan Detail"], "maintenance", True),
    # Logo & Branding
    ("Logo Starter", "Logo profesional yang siap dalam 24 jam. 2 opsi desain dengan revisi minor sampai 2x. Cepat, profesional, dan ekonomis - cocok untuk yang butuh logo berkualitas tanpa nunggu lama.", 250000, ["2 Opsi Desain Logo", "Format File: JPEG & PNG", "Selesai Maks. 24 Jam", "2x Revisi Minor", "File Siap Pakai untuk Digital"], "logo", False),
    ("Logo Pro", "Logo berkualitas tinggi dengan file vektor master dan 3D mockup. 3 opsi desain dengan revisi sampai 3x. File siap pakai untuk cetak & digital dengan fleksibilitas penggunaan di semua media.", 450000, ["3 Opsi Desain Logo", "Format File: Bitmap + Vector (Master File)", "3D Mockup", "Selesai Maks. 24 Jam", "3x Revisi", "File Siap Pakai untuk Cetak & Digital"], "logo", False),
    ("Logo Expert", "Brand identity lengkap yang bikin bisnis Anda terlihat profesional dan konsisten. 4 opsi desain logo, unlimited revisi, plus kartu nama, kop surat, dan stempel. Investasi sekali untuk brand yang kuat.", 1500000, ["4 Opsi Desain Logo", "Full Vector & Identity Assets", "Desain Kartu Nama", "Desain Kop Surat & Amplop", "Desain Stempel", "Selesai Maks. 3 Hari", "Unlimited Revisi", "Brand Guidelines Document", "File Siap Pakai untuk Semua Media"], "logo", False),
]
