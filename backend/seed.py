...
products_data = [
    ...
    ("Web Starter (Tahunan)", "Mulai bisnis online Anda hari ini! Website 1 halaman yang dirancang khusus untuk mengubah pengunjung menjadi pelanggan. Sudah termasuk domain dan hosting tahun pertama — tidak ada biaya tersembunyi. Investasi kecil untuk kehadiran digital yang profesional.", 1000000, ["1 Halaman (Sales Focus)", "Domain & Hosting Termasuk (Tahun ke-1)", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Pengerjaan 5-7 Hari Kerja"], "web_dev", False),
    ("Web Pro (Tahunan)", "Website profesional yang membuat bisnis Anda terlihat serius dan kredibel di mata pelanggan. Hingga 5 halaman dengan semua fitur penting: Google Maps agar pelanggan mudah menemukan Anda, SEO dasar agar muncul di pencarian Google, dan analytics untuk melacak pengunjung. Solusi lengkap untuk bisnis yang ingin tumbuh online.", 2250000, ["Hingga 5 Halaman", "Domain & Hosting Termasuk (Tahun ke-1)", "Google Maps Embed", "SEO Dasar (Meta Tags, Heading, Sitemap)", "Google Analytics Setup", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Pengerjaan 7-10 Hari Kerja"], "web_dev", False),
    ("Web Expert (Tahunan)", "Dominasi pasar digital dengan website premium yang bekerja 24/7 untuk bisnis Anda. Hingga 10 halaman dengan blog system untuk konten marketing, email profesional untuk komunikasi bisnis, dan speed optimization agar pelanggan tidak kabur. Paket lengkap untuk bisnis yang serius ingin jadi market leader di industri Anda.", 3750000, ["Hingga 10 Halaman", "Domain & Hosting Termasuk (Tahun ke-1)", "Blog/Article System", "Professional Email (Titan Mail)", "Speed Optimization", "Google Maps Embed", "SEO Lengkap + Analytics", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Pengerjaan 10-14 Hari Kerja"], "web_dev", False),
    # Web Development Bulanan
    ("Web Starter (Bulanan)", "Punya website profesional tanpa modal besar! Cukup bayar bulanan, domain & hosting sudah termasuk. Cocok untuk bisnis yang baru mulai dan ingin test pasar digital dulu. Tidak ada kontrak jangka panjang — berhenti kapan saja.", 120000, ["1 Halaman (Sales Focus)", "Domain & Hosting Termasuk (Tahun ke-1)", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Bisa Berhenti Kapan Saja", "Pengerjaan 5-7 Hari Kerja"], "web_dev_bulanan", True),
    ("Web Pro (Bulanan)", "Website profesional lengkap dengan pembayaran bulanan yang ramah di kantong. Termasuk Google Maps, SEO dasar, dan Analytics — semua yang Anda butuhkan untuk ditemukan pelanggan di Google. Solusi terbaik untuk bisnis yang ingin tampil profesional tanpa investasi besar di awal.", 250000, ["Hingga 5 Halaman", "Domain & Hosting Termasuk (Tahun ke-1)", "Google Maps Embed", "SEO Dasar (Meta Tags, Heading, Sitemap)", "Google Analytics Setup", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Bisa Berhenti Kapan Saja", "Pengerjaan 7-10 Hari Kerja"], "web_dev_bulanan", True),
    ("Web Expert (Bulanan)", "Website premium dengan semua fitur canggih, bayar bulanan tanpa memberatkan cashflow. Dilengkapi blog system untuk konten marketing, email profesional untuk komunikasi bisnis, dan speed optimization. Untuk bisnis yang serius ingin dominasi pasar digital tanpa investasi besar di awal.", 375000, ["Hingga 10 Halaman", "Domain & Hosting Termasuk (Tahun ke-1)", "Blog/Article System", "Professional Email (Titan Mail)", "Speed Optimization", "Google Maps Embed", "SEO Lengkap + Analytics", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Bisa Berhenti Kapan Saja", "Pengerjaan 10-14 Hari Kerja"], "web_dev_bulanan", True),
    # SEO & Google Maps
    ("SEO Starter", "Mulai muncul di Google dan ditemukan pelanggan lokal! Paket entry-level yang fokus pada Google Business Profile dan konten lokal. Dengan hanya 2 artikel per bulan, bisnis Anda mulai terlihat di pencarian Google. Investasi kecil untuk pertumbuhan besar — tanpa kontrak jangka panjang.", 1000000, ["Setup & Update Foto Google Business Profile", "2 Artikel Lokal SEO / Bulan", "On-Page SEO Dasar", "Laporan Performa Bulanan", "Riset Keyword Lokal", "Tanpa Kontrak Jangka Panjang"], "seo", True),
    ("SEO Pro", "Naik peringkat Google secara konsisten dan kalahkan kompetitor lokal Anda! Paket profesional dengan audit mendalam menggunakan Semrush, strategi keyword yang terukur, dan 6-8 artikel strategis per bulan. Dilengkapi laporan detail trafik & ranking agar Anda bisa lihat ROI jelas. Untuk bisnis yang serius ingin tumbuh lewat Google.", 2500000, ["Full Management Google Business Profile", "6-8 Artikel Strategis / Bulan", "Audit Semrush & Keyword Gap Analysis", "Laporan Detail Trafik & Ranking", "On-Page & Technical SEO", "Competitor Monitoring", "Tanpa Kontrak Jangka Panjang"], "seo", True),
    ("SEO Expert", "Jadilah market leader di Google dengan paket SEO premium! Dominasi pencarian lokal dan nasional dengan 10-12 artikel otoritas per bulan, competitor gap analysis, CRO optimization, dan full insight strategi bulanan. Termasuk review reply untuk membangun reputasi bisnis. Untuk bisnis yang tidak mau kalah dari kompetitor dan ingin jadi nomor 1 di industri Anda.", 4500000, ["Full Management Google Business Profile + Review Reply", "10-12 Artikel Otoritas / Bulan", "Competitor Gap Analysis & CRO Optimization", "Full Monthly Strategy Insights", "On-Page, Technical & Local SEO", "Conversion Rate Optimization", "Priority Support", "Tanpa Kontrak Jangka Panjang"], "seo", True),
    # Social Media
    ("Sosmed Starter", "Mulai aktif di media sosial dengan konten profesional! 9 konten branded per bulan dengan caption dan hashtag yang dioptimasi untuk engagement. Cocok untuk bisnis yang ingin mulai bangun presence digital tanpa repot. Investasi kecil untuk brand awareness yang besar.", 500000, ["9 Konten Feed (3x Seminggu)", "Branded Template Design", "Caption & Hashtag Optimized", "1 Platform (Instagram/Facebook)", "Content Scheduling", "Laporan Bulanan"], "socmed", True),
    ("Sosmed Pro", "Sosmed aktif setiap hari dengan konten yang mengubah followers menjadi pelanggan! 15 konten feed per bulan, 2 video reels, content plan strategis, dan copywriting persuasif. Dilengkapi laporan performa mingguan agar Anda bisa lihat pertumbuhan jelas. Untuk bisnis yang serius ingin tumbuh lewat media sosial.", 1200000, ["15 Konten Feed (Hampir Setiap Hari)", "2 Video Reels Editing Sederhana", "Content Plan & Strategy Bulanan", "Caption Persuasif (Copywriting)", "2 Platform (Instagram + Facebook)", "Hashtag Research & Scheduling", "Laporan Performa Mingguan"], "socmed", True),
    ("Sosmed Expert", "Dominasi media sosial dengan konten harian berkualitas tinggi! 24 konten feed per bulan, 4 video reels premium, full branding guidelines, dan daily story template. Hadir di 3 platform (Instagram, Facebook, TikTok) dengan advanced content strategy dan competitor analysis. Paket lengkap untuk bisnis yang ingin jadi brand terdepan di media sosial.", 2000000, ["24 Konten Feed (Setiap Hari)", "4 Video Reels Premium Editing", "Full Branding Guidelines", "Daily Story Template & Design", "3 Platform (Instagram, Facebook, TikTok)", "Advanced Content Strategy", "Competitor Analysis", "Priority Support"], "socmed", True),
    # Maintenance
    ("Maintenance Starter", "Jaga website Anda tetap aman dan berjalan lancar! Backup mingguan, malware scan bulanan, dan update WordPress otomatis. Cocok untuk website statis yang butuh perawatan minimal tanpa ribet. Investasi kecil untuk keamanan besar.", 350000, ["Backup Mingguan (Weekly)", "Data Retention: 1 Bulan", "WordPress Core & Plugin Updates", "Malware Scan Bulanan", "Security Monitoring", "Laporan Bulanan"], "maintenance", True),
    ("Maintenance Pro", "Website selalu fresh, aman, dan optimal! Backup mingguan, malware scan, update konten bisnis, setup email profesional, dan manajemen Google Maps. Dilengkapi priority email support dan laporan mingguan detail. Untuk bisnis yang butuh website selalu tampil prima tanpa repot mengurus teknis.", 750000, ["Backup Mingguan (Weekly)", "Data Retention: 1 Bulan", "Setup & Troubleshoot Titan Mail", "Update Konten Bisnis (Teks/Gambar)", "Malware Scan + Removal", "Google Maps Management", "Performance Monitoring", "Priority Email Support", "Laporan Mingguan"], "maintenance", True),
    ("Maintenance Expert", "Website selalu optimal dengan priority response dan security hardening! Backup harian, malware scan + removal + recovery, performance optimization, dan uptime monitoring 24/7. Termasuk custom development hingga 5 jam/bulan untuk perubahan besar. Response time < 4 jam untuk masalah kritis. Untuk bisnis yang tidak bisa afford website down dan butuh performa maksimal.", 1500000, ["Backup Harian (Daily)", "Data Retention: 3 Bulan", "Full Priority Support (Response < 4 Jam)", "Custom Development (5 Jam/Bulan)", "Security Hardening & Monitoring", "Malware Scan + Removal + Recovery", "Performance Optimization", "Uptime Monitoring 24/7", "Laporan Mingguan Detail"], "maintenance", True),
    # Logo & Branding
    ("Logo Starter", "Logo profesional siap dalam 24 jam! 2 opsi desain dengan format JPEG & PNG transparan. Cepat, profesional, dan ekonomis — cocok untuk bisnis yang butuh logo berkualitas tanpa menunggu lama. File siap pakai untuk semua kebutuhan digital Anda.", 250000, ["2 Opsi Desain Logo", "Format File: JPEG & PNG (Transparent)", "Pengerjaan Maks. 24 Jam", "2x Revisi Minor", "File Siap Pakai untuk Digital"], "logo", False),
    ("Logo Pro", "Logo berkualitas tinggi dengan file vektor master dan 3D mockup presentation! 3 opsi desain dengan revisi hingga 3x. File siap pakai untuk cetak & digital dengan fleksibilitas penggunaan di semua media. Untuk bisnis yang butuh logo premium dengan kualitas profesional.", 450000, ["3 Opsi Desain Logo", "Format File: Bitmap + Vector (Master File)", "3D Mockup Presentation", "Pengerjaan Maks. 24 Jam", "3x Revisi", "File Siap Pakai untuk Cetak & Digital"], "logo", False),
    ("Logo Expert", "Bangun brand identity yang konsisten dan profesional! Paket lengkap: logo profesional plus kartu nama, kop surat, amplop, dan stempel. 4 opsi desain dengan unlimited revisi, brand guidelines document, dan file vector lengkap. Investasi sekali untuk brand yang kuat dan kredibel di mata pelanggan.", 1500000, ["4 Opsi Desain Logo", "Full Vector & Identity Assets", "Kartu Nama Design", "Kop Surat & Amplop Design", "Stempel Design", "Pengerjaan Maks. 3 Hari", "Unlimited Revisi", "Brand Guidelines Document", "File Siap Pakai untuk Semua Media"], "logo", False),
]
