...
products_data = [
    ...
    ("SEO Expert", "Bikin Anda jadi nomor 1 di Google untuk industri Anda. Kami urus semuanya dari profil Google, artikel 10-12 per bulan, analisis kompetitor, sampai optimasi konversi. Buat yang serius mau jadi market leader.", 4500000, ["Full Management Google Business Profile + Balas Ulasan", "10-12 Artikel Otoritas / Bulan", "Analisis Kompetitor & Optimasi Konversi", "Strategi Bulanan Lengkap", "SEO Lengkap", "Optimasi Konversi", "Dukungan Prioritas", "Tanpa Kontrak Jangka Panjang"], "seo", True),
    # Social Media
