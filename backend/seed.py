...
products_data = [
    ...
    ("Web Starter (Tahunan)", "Bayangkan pelanggan bisa cek bisnis Anda 24 jam, bahkan saat Anda tidur. Website 1 halaman ini bikin bisnis Anda terlihat serius dan dipercaya. Sudah termasuk domain dan hosting tahun pertama - tinggal pakai!", 1000000, ["1 Halaman Fokus Penjualan", "Domain & Hosting Tahun Pertama", "Tombol WhatsApp", "Sertifikat SSL (Aman)", "Tampilan Mobile Friendly", "Selesai 5-7 Hari Kerja"], "web_dev", False),
    ("Web Pro (Tahunan)", "Website 5 halaman lengkap yang bikin pelanggan gampang nemuin dan percaya bisnis Anda. Sudah termasuk Google Maps agar pelanggan mudah datang ke lokasi, SEO dasar supaya muncul di Google, dan analytics untuk tracking pengunjung.", 2250000, ["Hingga 5 Halaman", "Domain & Hosting Tahun Pertama", "Google Maps", "SEO Dasar", "Google Analytics", "Tombol WhatsApp", "Sertifikat SSL", "Tampilan Mobile", "Selesai 7-10 Hari Kerja"], "web_dev", False),
    ("Web Expert (Tahunan)", "Website 10 halaman premium yang bikin bisnis Anda terlihat seperti perusahaan besar dan dipercaya pelanggan. Sudah termasuk blog untuk konten marketing, email profesional, dan loading super cepat agar pelanggan tidak kabur.", 3750000, ["Hingga 10 Halaman", "Domain & Hosting Tahun Pertama", "Blog/Artikel", "Email Profesional", "Loading Cepat", "Google Maps", "SEO Lengkap + Analytics", "Tombol WhatsApp", "Sertifikat SSL", "Tampilan Mobile", "Selesai 10-14 Hari Kerja"], "web_dev", False),
    ...
    # Logo & Branding
    ("Logo Starter", "Bayangkan bisnis Anda punya logo profesional yang bikin pelanggan percaya. Logo yang siap dalam 24 jam dengan 2 opsi desain dan revisi minor sampai 2x. Cepat, profesional, dan ekonomis.", 250000, ["2 Opsi Desain Logo", "Format File: JPEG & PNG", "Selesai Maks. 24 Jam", "2x Revisi Minor", "File Siap Pakai untuk Digital"], "logo", False),
    ("Logo Pro", "Bayangkan bisnis Anda punya logo berkualitas tinggi yang bikin Anda terlihat profesional di semua media. Logo dengan file vektor master dan 3D mockup. 3 opsi desain dengan revisi sampai 3x.", 450000, ["3 Opsi Desain Logo", "Format File: Bitmap + Vector (Master File)", "3D Mockup", "Selesai Maks. 24 Jam", "3x Revisi", "File Siap Pakai untuk Cetak & Digital"], "logo", False),
    ("Logo Expert", "Bayangkan bisnis Anda punya brand identity lengkap yang bikin Anda terlihat profesional dan konsisten di semua media. Logo dengan 4 opsi desain, unlimited revisi, plus kartu nama, kop surat, dan stempel. Investasi sekali untuk brand yang kuat.", 1500000, ["4 Opsi Desain Logo", "Full Vector & Identity Assets", "Desain Kartu Nama", "Desain Kop Surat & Amplop", "Desain Stempel", "Selesai Maks. 3 Hari", "Unlimited Revisi", "Brand Guidelines Document", "File Siap Pakai untuk Semua Media"], "logo", False),
]
