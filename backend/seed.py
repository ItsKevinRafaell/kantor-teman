...
products_data = [
    ...
    ("Web Starter (Tahunan)", "Website 1 halaman profesional yang bikin bisnis Anda terlihat serius dan mudah dihubungi pelanggan 24/7. Kami kerjakan: (1) Konsultasi kebutuhan bisnis Anda, (2) Desain layout yang fokus penjualan dengan call-to-action jelas, (3) Setup domain dan hosting tahun pertama, (4) Integrasi WhatsApp button biar pelanggan bisa langsung chat, (5) SSL certificate buat keamanan, (6) Optimasi mobile biar enak dibuka di HP, (7) Testing di berbagai browser. Hasilnya: website siap pakai dalam 5-7 hari kerja!", 1000000, ["1 Halaman (Sales Focus)", "Domain & Hosting Termasuk (Tahun ke-1)", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Pengerjaan 5-7 Hari Kerja"], "web_dev", False),
    ("Web Pro (Tahunan)", "Website 5 halaman lengkap yang bikin pelanggan gampang nemuin dan percaya bisnis Anda. Kami kerjakan: (1) Riset kebutuhan bisnis dan kompetitor, (2) Desain 5 halaman: Beranda, Tentang Kami, Layanan, Galeri/Portfolio, Kontak, (3) Setup Google Maps interaktif biar pelanggan gampang datang ke lokasi, (4) SEO dasar: meta tags, heading structure, sitemap submission ke Google, (5) Google Analytics setup buat tracking pengunjung, (6) WhatsApp integration, (7) Mobile responsive design, (8) SSL security. Hasilnya: bisnis Anda muncul di Google dan pelanggan bisa find Anda dengan mudah!", 2250000, ["Hingga 5 Halaman", "Domain & Hosting Termasuk (Tahun ke-1)", "Google Maps Embed", "SEO Dasar (Meta Tags, Heading, Sitemap)", "Google Analytics Setup", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Pengerjaan 7-10 Hari Kerja"], "web_dev", False),
    ("Web Expert (Tahunan)", "Website 10 halaman premium yang bikin bisnis Anda terlihat seperti perusahaan besar dan dipercaya pelanggan. Kami kerjakan: (1) Konsultasi mendalam dan strategi konten, (2) Desain 10 halaman lengkap termasuk blog system buat konten marketing, (3) Setup email profesional (nama@bisnisanda.com) pakai Titan Mail, (4) Speed optimization biar loading super cepat, (5) Google Maps integration, (6) SEO lengkap + Analytics dashboard, (7) WhatsApp integration, (8) Mobile responsive di semua device, (9) SSL security, (10) Training cara update konten. Hasilnya: website yang kerja 24/7 buat bisnis Anda dan bikin pelanggan percaya pilih Anda!", 3750000, ["Hingga 10 Halaman", "Domain & Hosting Termasuk (Tahun ke-1)", "Blog/Article System", "Professional Email (Titan Mail)", "Speed Optimization", "Google Maps Embed", "SEO Lengkap + Analytics", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Pengerjaan 10-14 Hari Kerja"], "web_dev", False),
    # Web Development Bulanan
    ("Web Starter (Bulanan)", "Website 1 halaman profesional dengan pembayaran bulanan yang ramah di kantong. Kami kerjakan: (1) Konsultasi kebutuhan bisnis, (2) Desain layout fokus penjualan, (3) Setup domain dan hosting tahun pertama, (4) WhatsApp button integration, (5) SSL certificate, (6) Mobile responsive design, (7) Testing dan deployment. Cocok buat yang baru mulai bisnis online dan mau test market dulu tanpa commitment besar. Bisa berhenti kapan saja!", 120000, ["1 Halaman (Sales Focus)", "Domain & Hosting Termasuk (Tahun ke-1)", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Bisa Berhenti Kapan Saja", "Pengerjaan 5-7 Hari Kerja"], "web_dev_bulanan", True),
    ("Web Pro (Bulanan)", "Website 5 halaman lengkap dengan pembayaran bulanan. Kami kerjakan: (1) Riset bisnis dan kompetitor, (2) Desain 5 halaman: Beranda, Tentang, Layanan, Galeri, Kontak, (3) Google Maps setup, (4) SEO dasar biar muncul di Google, (5) Google Analytics tracking, (6) WhatsApp integration, (7) Mobile responsive, (8) SSL security. Solusi terbaik buat yang mau tampil profesional di Google tanpa investasi besar di awal!", 250000, ["Hingga 5 Halaman", "Domain & Hosting Termasuk (Tahun ke-1)", "Google Maps Embed", "SEO Dasar (Meta Tags, Heading, Sitemap)", "Google Analytics Setup", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Bisa Berhenti Kapan Saja", "Pengerjaan 7-10 Hari Kerja"], "web_dev_bulanan", True),
    ("Web Expert (Bulanan)", "Website 10 halaman premium dengan pembayaran bulanan. Kami kerjakan: (1) Konsultasi dan strategi konten, (2) Desain 10 halaman + blog system buat marketing, (3) Setup email profesional (nama@bisnisanda.com), (4) Speed optimization biar loading cepat, (5) Google Maps, (6) SEO lengkap + Analytics, (7) WhatsApp integration, (8) Mobile responsive, (9) SSL security, (10) Training update konten. Buat yang serius mau dominasi pasar digital tanpa memberatkan cashflow!", 375000, ["Hingga 10 Halaman", "Domain & Hosting Termasuk (Tahun ke-1)", "Blog/Article System", "Professional Email (Titan Mail)", "Speed Optimization", "Google Maps Embed", "SEO Lengkap + Analytics", "WhatsApp Chat Button", "SSL Certificate (HTTPS)", "Mobile Responsive Design", "Bisa Berhenti Kapan Saja", "Pengerjaan 10-14 Hari Kerja"], "web_dev_bulanan", True),
    # SEO & Google Maps
    ("SEO Starter", "Paket SEO lokal yang bikin bisnis Anda muncul di Google saat orang cari layanan di daerah Anda. Kami kerjakan: (1) Setup dan optimasi Google Business Profile lengkap, (2) Update foto bisnis secara berkala, (3) Riset keyword lokal yang sering dicari pelanggan, (4) Buat 2 artikel lokal SEO per bulan, (5) On-page SEO dasar: meta tags, heading, internal linking, (6) Submit sitemap ke Google, (7) Laporan performa bulanan: ranking, traffic, impressions. Investasi kecil buat pertumbuhan besar tanpa kontrak jangka panjang!", 1000000, ["Setup & Update Foto Google Business Profile", "2 Artikel Lokal SEO / Bulan", "On-Page SEO Dasar", "Laporan Performa Bulanan", "Riset Keyword Lokal", "Tanpa Kontrak Jangka Panjang"], "seo", True),
    ("SEO Pro", "Paket SEO profesional yang bikin bisnis Anda naik peringkat di Google dan kalahkan kompetitor lokal. Kami kerjakan: (1) Audit website mendalam pakai Semrush, (2) Analisis kompetitor lokal, (3) Full management Google Business Profile, (4) Riset keyword strategis dengan volume pencarian tinggi, (5) Buat 6-8 artikel SEO per bulan, (6) On-page & technical SEO optimization, (7) Competitor monitoring bulanan, (8) Laporan detail: trafik, ranking, ROI. Buat yang serius mau tumbuh lewat Google!", 2500000, ["Full Management Google Business Profile", "6-8 Artikel Strategis / Bulan", "Audit Semrush & Keyword Gap Analysis", "Laporan Detail Trafik & Ranking", "On-Page & Technical SEO", "Competitor Monitoring", "Tanpa Kontrak Jangka Panjang"], "seo", True),
    ("SEO Expert", "Paket SEO premium yang bikin Anda jadi nomor 1 di Google untuk industri Anda. Kami kerjakan: (1) Full management Google Business Profile + review reply buat bangun reputasi, (2) Analisis kompetitor mendalam, (3) Riset keyword lokal dan nasional, (4) Buat 10-12 artikel otoritas per bulan, (5) CRO optimization biar pengunjung jadi pelanggan, (6) Full monthly strategy insights dan konsultasi, (7) On-page, technical & local SEO lengkap, (8) Priority support. Buat yang serius mau jadi market leader dan dominasi pasar!", 4500000, ["Full Management Google Business Profile + Review Reply", "10-12 Artikel Otoritas / Bulan", "Competitor Gap Analysis & CRO Optimization", "Full Monthly Strategy Insights", "On-Page, Technical & Local SEO", "Conversion Rate Optimization", "Priority Support", "Tanpa Kontrak Jangka Panjang"], "seo", True),
    # Social Media
    ("Sosmed Starter", "Paket sosmed yang bikin media sosial bisnis Anda aktif dan profesional. Kami kerjakan: (1) Konsultasi target audiens dan goals, (2) Buat 9 konten feed per bulan (3x seminggu), (3) Desain branded template yang konsisten, (4) Copywriting caption yang engaging, (5) Riset hashtag optimal, (6) Content scheduling otomatis, (7) Laporan performa bulanan. Cocok buat yang baru mulai bangun presence digital tanpa repot. Investasi kecil buat brand awareness yang besar!", 500000, ["9 Konten Feed (3x Seminggu)", "Branded Template Design", "Caption & Hashtag Optimized", "1 Platform (Instagram/Facebook)", "Content Scheduling", "Laporan Bulanan"], "socmed", True),
    ("Sosmed Pro", "Paket sosmed yang bikin followers jadi pelanggan. Kami kerjakan: (1) Strategi konten bulanan, (2) Buat 15 konten feed per bulan (hampir setiap hari), (3) Edit 2 video reels sederhana, (4) Content plan strategis dengan tema mingguan, (5) Copywriting persuasif yang bikin orang beli, (6) Hadir di 2 platform (Instagram + Facebook), (7) Riset hashtag & scheduling, (8) Laporan performa mingguan. Buat yang serius mau tumbuh lewat media sosial!", 1200000, ["15 Konten Feed (Hampir Setiap Hari)", "2 Video Reels Editing Sederhana", "Content Plan & Strategy Bulanan", "Caption Persuasif (Copywriting)", "2 Platform (Instagram + Facebook)", "Hashtag Research & Scheduling", "Laporan Performa Mingguan"], "socmed", True),
    ("Sosmed Expert", "Paket sosmed premium yang bikin Anda dominasi media sosial. Kami kerjakan: (1) Advanced content strategy, (2) Buat 24 konten feed per bulan (setiap hari), (3) Edit 4 video reels premium berkualitas tinggi, (4) Full branding guidelines document, (5) Daily story template & design, (6) Hadir di 3 platform (Instagram, Facebook, TikTok), (7) Competitor analysis bulanan, (8) Priority support. Paket lengkap buat yang mau jadi brand terdepan di media sosial!", 2000000, ["24 Konten Feed (Setiap Hari)", "4 Video Reels Premium Editing", "Full Branding Guidelines", "Daily Story Template & Design", "3 Platform (Instagram, Facebook, TikTok)", "Advanced Content Strategy", "Competitor Analysis", "Priority Support"], "socmed", True),
    # Maintenance
    ("Maintenance Starter", "Paket maintenance yang bikin website Anda tetap aman dan jalan lancar. Kami kerjakan: (1) Backup mingguan otomatis, (2) Malware scan bulanan, (3) Update WordPress core & plugin otomatis, (4) Security monitoring 24/7, (5) Data retention 1 bulan, (6) Laporan bulanan lengkap. Cocok buat website statis yang butuh perawatan minimal tanpa ribet. Investasi kecil buat keamanan besar!", 350000, ["Backup Mingguan (Weekly)", "Data Retention: 1 Bulan", "WordPress Core & Plugin Updates", "Malware Scan Bulanan", "Security Monitoring", "Laporan Bulanan"], "maintenance", True),
    ("Maintenance Pro", "Paket maintenance yang bikin website selalu fresh, aman, dan optimal. Kami kerjakan: (1) Backup mingguan, (2) Malware scan & removal, (3) Update konten bisnis (teks/gambar) sesuai permintaan, (4) Setup & troubleshoot email profesional Titan Mail, (5) Google Maps management, (6) Performance monitoring, (7) Priority email support, (8) Laporan mingguan detail. Buat yang butuh website selalu tampil prima tanpa repot urus teknis!", 750000, ["Backup Mingguan (Weekly)", "Data Retention: 1 Bulan", "Setup & Troubleshoot Titan Mail", "Update Konten Bisnis (Teks/Gambar)", "Malware Scan + Removal", "Google Maps Management", "Performance Monitoring", "Priority Email Support", "Laporan Mingguan"], "maintenance", True),
    ("Maintenance Expert", "Paket maintenance premium dengan priority response dan security hardening. Kami kerjakan: (1) Backup harian otomatis, (2) Malware scan + removal + recovery, (3) Performance optimization biar loading cepat, (4) Uptime monitoring 24/7, (5) Custom development sampai 5 jam/bulan buat perubahan besar, (6) Security hardening, (7) Full priority support dengan response time < 4 jam buat masalah kritis, (8) Laporan mingguan detail. Buat yang gak bisa afford website down dan butuh performa maksimal!", 1500000, ["Backup Harian (Daily)", "Data Retention: 3 Bulan", "Full Priority Support (Response < 4 Jam)", "Custom Development (5 Jam/Bulan)", "Security Hardening & Monitoring", "Malware Scan + Removal + Recovery", "Performance Optimization", "Uptime Monitoring 24/7", "Laporan Mingguan Detail"], "maintenance", True),
    # Logo & Branding
    ("Logo Starter", "Paket logo profesional yang siap dalam 24 jam. Kami kerjakan: (1) Konsultasi singkat tentang bisnis dan preferensi, (2) Buat 2 opsi desain logo, (3) Revisi minor sampai 2x, (4) Finalisasi desain, (5) Export file JPEG & PNG transparan. Cepat, profesional, dan ekonomis - cocok buat yang butuh logo berkualitas tanpa nunggu lama. File siap pakai buat semua kebutuhan digital Anda!", 250000, ["2 Opsi Desain Logo", "Format File: JPEG & PNG (Transparent)", "Pengerjaan Maks. 24 Jam", "2x Revisi Minor", "File Siap Pakai untuk Digital"], "logo", False),
    ("Logo Pro", "Paket logo berkualitas tinggi dengan file vektor master. Kami kerjakan: (1) Konsultasi mendalam tentang brand, (2) Buat 3 opsi desain logo, (3) Revisi sampai 3x, (4) Finalisasi desain, (5) 3D mockup presentation, (6) Export file bitmap + vector master (AI, EPS, SVG). File siap pakai buat cetak & digital dengan fleksibilitas penggunaan di semua media. Buat yang butuh logo premium dengan kualitas profesional!", 450000, ["3 Opsi Desain Logo", "Format File: Bitmap + Vector (Master File)", "3D Mockup Presentation", "Pengerjaan Maks. 24 Jam", "3x Revisi", "File Siap Pakai untuk Cetak & Digital"], "logo", False),
    ("Logo Expert", "Paket brand identity lengkap yang bikin bisnis Anda terlihat profesional dan konsisten. Kami kerjakan: (1) Konsultasi mendalam tentang visi dan target audiens, (2) Buat 4 opsi desain logo, (3) Unlimited revisi, (4) Finalisasi logo, (5) Desain kartu nama, (6) Desain kop surat & amplop, (7) Desain stempel, (8) Brand guidelines document, (9) Export full vector & identity assets. Investasi sekali buat brand yang kuat dan kredibel di mata pelanggan!", 1500000, ["4 Opsi Desain Logo", "Full Vector & Identity Assets", "Kartu Nama Design", "Kop Surat & Amplop Design", "Stempel Design", "Pengerjaan Maks. 3 Hari", "Unlimited Revisi", "Brand Guidelines Document", "File Siap Pakai untuk Semua Media"], "logo", False),
]
