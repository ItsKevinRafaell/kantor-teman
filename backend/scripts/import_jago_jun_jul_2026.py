...
TXS: list[tuple[str, str, float, str, str, str]] = [
    ...
    ("2026-06-08", "expense", 35_000.00, "Makanan", "QRIS Roy Antidonasi Creative GoPay", "3942413940"),
    ("2026-06-08", "expense", 6_000.00, "Makanan", "QRIS Deal store Grosir GoPay", "3944745581"),
    ...
    ("2026-06-30", "expense", 25_064.00, "Makanan", "QRIS WARUNG MBA SAR MTR BRT GoPay", "260630-E7WX-7NQ7YZ"),
    # ---- July 2026 ----
    ...
    ("2026-07-08", "expense", 150_000.00, "Makanan", "QRIS Roy Antidonasi Creative GoPay", "260708-T2E3-AE6QZY"),
    ...
    ("2026-07-16", "expense", 20_000.00, "Makanan", "QRIS NUGRAHA STORE DANA", "260716-JQFZ-XDG686"),
    ("2026-07-17", "expense", 40_000.00, "Makanan", "QRIS NUGRAHA STORE DANA", "260717-ZQX2-HPT4TV"),
    ("2026-07-18", "expense", 4_000.00, "Tools & Langganan", "QRIS Pakasir Pakai Donk", "260718-3A8K-8QZB8Q"),
    ("2026-07-18", "expense", 30_000.00, "Makanan", "QRIS Roy Antidonasi Creative GoPay", "260718-EREF-93UQ8R"),
    ("2026-07-19", "expense", 100_443.00, "Makanan", "QRIS Trijaya Indonesia ShopeePay", "260719-F3D6-6VCH92"),
    ("2026-07-19", "expense", 100_443.00, "Makanan", "QRIS Trijaya Indonesia ShopeePay (2)", "260719-7MMQ-YBYAFL"),
    ("2026-07-19", "income", 100_443.00, "Refund", "QR refund Trijaya Indonesia (QRDO1-R)", "d67dc02a-8d31-42c1-afdf"),
    ("2026-07-20", "expense", 45_000.00, "Makanan", "QRIS WARUNG MBA SAR MTR BRT GoPay", "260720-ZH4V-4GJ72G"),
    ("2026-07-21", "expense", 20_000.00, "Makanan", "QRIS NUGRAHA STORE DANA", "260721-VWLU-8JZZNR"),
]
