  ...
  return (
    <div className="bg-white dark:bg-[var(--bg-canvas)] rounded-2xl border border-gray-200 dark:border-gray-700 p-5 space-y-4">
      ...
      <button onClick={() => setShowAdvanced(p => !p)}
        className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-neutral-600 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors border border-gray-200 dark:border-gray-700 w-full">
        ...
        <div className="space-y-4 border border-gray-100 dark:border-gray-700 rounded-xl p-4 bg-gray-50/50 dark:bg-gray-800/30">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="number" value={searchVolume} onChange={e => setSearchVolume(e.target.value)}
                placeholder="1200"
                className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:ring-2 focus:ring-neutral-400 dark:focus:ring-neutral-600 outline-none" />
            </div>
            <div>
                ...
                <button key={opt.value} onClick={() => toggleSerp(opt.value)}
                  className={`px-3 py-1 rounded-full text-xs font-medium transition-all border
                    ${serpFeatures.includes(opt.value)
                      ...
                      : "bg-white dark:bg-gray-800 text-neutral-500 border-gray-200 dark:border-gray-700 hover:border-neutral-300"}`}>
                  {opt.label}
                </button>
              ))}
            </div>
          ...
          <div>
            ...
            <textarea value={faqTopics} onChange={e => setFaqTopics(e.target.value)} rows={3}
              ...
              className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm resize-none focus:ring-2 focus:ring-neutral-400 dark:focus:ring-neutral-600 outline-none" />
          </div>
      ...
      {sharedContext.length > 0 && (
        <p className="text-xs text-neutral-600 dark:text-neutral-400 bg-neutral-50 dark:bg-neutral-900/20 px-3 py-2 rounded-lg">
      ...
      {result && (
        <div className="space-y-3 pt-2 border-t border-gray-100 dark:border-gray-700">
          <div className="bg-neutral-50 dark:bg-neutral-900/20 rounded-xl p-3">
