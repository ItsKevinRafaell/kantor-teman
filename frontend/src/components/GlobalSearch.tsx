...
const PAGES: SearchResult[] = [
  ...
  { id: "p-board", kind: "page", title: "Board (kanban harian)", href: "/board" },
  { id: "p-workspace", kind: "page", title: "Workspace (sheet retainer)", href: "/workspace" },
  { id: "p-proposals", kind: "page", title: "Proposal", href: "/proposals" },
  { id: "p-finance", kind: "page", title: "Keuangan", href: "/finance" },
  { id: "p-docs", kind: "page", title: "Dokumen (hub)", href: "/documents" },
  { id: "p-generator", kind: "page", title: "Dokumen Resmi", href: "/documents/generator" },
  { id: "p-reports", kind: "page", title: "Laporan Klien (delivery)", href: "/documents/reports" },
  ...
  { id: "p-guide", kind: "page", title: "Panduan", href: "/docs" },
  ...
  { id: "p-chat", kind: "page", title: "Chat AI", href: "/chat" },
];
