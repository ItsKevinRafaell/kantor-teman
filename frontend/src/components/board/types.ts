...
export const COLUMN_COLORS: Record<string, { bg: string; border: string; text: string }> = {
  ...
  red: { bg: "bg-neutral-50 dark:bg-neutral-900/40", border: "border-neutral-200 dark:border-neutral-700", text: "text-neutral-600 dark:text-neutral-300" },
  orange: { bg: "bg-neutral-50 dark:bg-neutral-900/40", border: "border-neutral-200 dark:border-neutral-700", text: "text-neutral-600 dark:text-neutral-300" },
...
export const BOARD_TOP_BORDER: Record<string, string> = {
  ...
  red: "border-t-4 border-neutral-300 dark:border-neutral-600",
  orange: "border-t-4 border-neutral-300 dark:border-neutral-600",
...
export const CARD_COLORS: Record<string, { bg: string; accent: string; text: string }> = {
  ...
  red: { bg: "bg-neutral-50 dark:bg-neutral-900/30", accent: "", text: "text-neutral-600 dark:text-neutral-300" },
  orange: { bg: "bg-neutral-50 dark:bg-neutral-900/30", accent: "", text: "text-neutral-600 dark:text-neutral-300" },
...
export const LABEL_COLORS: Record<string, string> = {
  ...
  slate: "bg-slate-500",
  red: "bg-neutral-500", orange: "bg-neutral-500",
  warm: "bg-neutral-500",
