...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-full overflow-x-hidden bg-[var(--bg-main)]">
      {/* Toast */}
      {toast && (
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        <div className="p-4 border-b border-[var(--border-subtle)] flex items-center gap-3 bg-[var(--bg-surface)]">
          ...
          <button
            ...
            className={`hidden sm:block p-2 rounded-lg ${showMemoryPanel ? "bg-brand-yellow/10 text-brand-yellow" : "text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800"}`}
            title="Memory Bank"
          >
          ...
          <button
            ...
            className={`hidden sm:block p-2 rounded-lg ${showProjectSettings ? "bg-brand-yellow/10 text-brand-yellow" : "text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800"}`}
          ...
          <button
            ...
            className={`hidden sm:block p-2 rounded-lg ${showApiSettings ? "bg-brand-yellow/10 text-brand-yellow" : "text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800"}`}
            title="API Settings"
          >
          ...
          <button
            ...
            className="hidden sm:block p-2 rounded-lg text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800 disabled:opacity-50"
            title="Export Chat"
          >
