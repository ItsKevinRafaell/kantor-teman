    ...
    <div className="flex flex-col md:flex-row gap-4 md:gap-6 h-full">
      ...
      <aside className="w-full md:w-48 shrink-0 flex flex-col gap-1">
        ...
        <button onClick={selectUnfoldered}
          className={`flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium transition-colors text-left w-full ${showUnfoldered ? "bg-neutral-100 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-200 font-semibold" : "text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800"}`}>
        ...
        {folders.map(folder => (
          <div key={folder.id} onClick={() => selectFolder(folder.id)}
            className={`group flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium cursor-pointer transition-colors ${selectedFolder === folder.id ? "bg-neutral-100 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-200 font-semibold" : "text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800"}`}>
