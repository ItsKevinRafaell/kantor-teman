    ...
    <div className="max-w-6xl space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/finance" className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-colors">
            <ArrowLeft size={18} />
          </Link>
          <div>
            <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-50">Subscriptions</h1>
            <p className="text-sm text-gray-400 mt-0.5">Kelola langganan rutin bisnis.</p>
          </div>
        </div>
        <div className="flex gap-2">
          <button onClick={runAutoDeduct} className="px-4 py-2.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm font-semibold rounded-xl transition-colors">
            Auto-Deduct
          </button>
