...
const SECTIONS: DocSection[] = [
  ...
  },
  {
    ...
    content: {
      ...
      cara: [
        ...
        "Klik Convert untuk jadikan klien (Contact)",
      ],
      fitur: [
        "Lead score AI berdasarkan rating, review, recency",
        "Ghost viewer detection — deteksi lead yang baca proposal tapi diam",
        "Bulk filter dan export CSV",
        "Map view untuk lihat sebaran geografis",
        "Soft-delete dengan restore button",
      ],
      tips: [
        "Score >70 = hot lead, prioritaskan follow-up.",
  ...
  },
  {
    ...
    content: {
      ...
      cara: [
        "Buka /clients atau detail lead → klik Buat Proposal",
        ...
        "Klien klik Accept → admin dapat notifikasi WA, Project auto-created",
      ],
      fitur: [
        "Tracking pixel: tahu kapan klien buka proposal",
  ...
  },
  {
    ...
    content: {
      ...
      tips: [
        ...
        "Tag transaksi dengan client_id untuk dana talangan.",
  ...
  },
  {
    ...
    icon: <Wallet size={16} />,
    content: {
      apa: "Track recurring expenses bulanan/tahunan. Sistem auto-deduct saat tanggal billing.",
      cara: [
        "Buka /finance/subscriptions",
        "Tambah langganan (nama, jumlah, billing cycle, next date)",
        "Klik 'Catat Pengeluaran Bulan Ini' setiap awal bulan",
        "Sistem buat expense transaction otomatis",
      ],
      fitur: [
        "Billing cycle: monthly, yearly, weekly, daily",
        "Days-until countdown",
        "Auto-deduct dengan satu klik",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    content: {
      ...
      tips: [
        ...
        "Audit log retain 90 hari default.",
      ],
    },
  },
];
