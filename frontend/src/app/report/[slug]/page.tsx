...
export default function PublicReportPage() {
  ...
  const waTextExpired = `Halo ${report.admin_name || "Admin"}, saya telat membuka laporan audit untuk ${report.nama_usaha} dan kuotanya sudah habis terkunci. Apakah masih ada slot antrean kosong untuk bulan depan?`;
        ...
        {!discountExpired ? (
          ...
          <section className="bg-white dark:bg-zinc-900 border-2 border-zinc-200 dark:border-zinc-700 rounded-2xl p-6 text-center print:hidden">
            <div className="space-y-3">
              <svg className="w-12 h-12 mx-auto text-zinc-600 dark:text-zinc-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
              <p className="text-zinc-900 dark:text-zinc-100 font-bold text-base leading-relaxed">Maaf, Kuota Promo Slot Optimasi SEO &amp; Web untuk Wilayah <span className="text-amber-600">{city}</span> Bulan Ini Telah Habis Terkunci.</p>
              <p className="text-zinc-600 dark:text-zinc-400 text-sm font-medium">Anda masih bisa mendaftar antrean untuk bulan depan.</p>
            </div>
          </section>
        )}
      ...
      {!discountExpired && (
        <div className="fixed bottom-0 left-0 right-0 z-50 print:hidden overflow-hidden">
          <div className="max-w-3xl mx-auto px-4 pb-4">
            <a href={`https://wa.me/${report.admin_wa || ""}?text=${encodeURIComponent(`Halo ${report.admin_name || "Admin"}, saya sudah baca laporan audit digital untuk ${report.nama_usaha}. Saya tertarik untuk diskusi lebih lanjut.`)}`}
