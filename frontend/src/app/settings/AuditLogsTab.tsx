  ...
  return (
    <div className="max-w-6xl space-y-3">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-sm font-bold text-neutral-800 dark:text-neutral-200">Audit Log</h2>
          <p className="text-xs text-gray-400 mt-0.5">Riwayat aktivitas sistem — realtime (refresh tiap 5 detik).</p>
        </div>
